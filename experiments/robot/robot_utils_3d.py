"""Robot evaluation helpers that route OpenVLA action queries through the additive 3D path."""
...
from experiments.robot.openvla_utils_3d import get_vla, get_vla_action
...
def get_action(
    ...
    depth_projectors_list: Optional[tuple] = None,
