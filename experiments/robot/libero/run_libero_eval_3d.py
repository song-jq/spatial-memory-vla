"""
run_libero_eval_3d.py

Evaluates a trained policy in LIBERO with additive depth tokens enabled through parallel 3D modules.
"""
...
sys.path.append("../..")
from experiments.robot.libero.libero_utils_3d import (
...
from experiments.robot.openvla_utils_3d import (
    get_action_head,
...
from experiments.robot.robot_utils_3d import (
    DATE_TIME,
    get_action,
...
def initialize_model(cfg: GenerateConfig):
    ...
    if cfg.use_depth:
        depth_projectors_list = get_depth_projectors(cfg)
    ...
    return model, action_head, proprio_projector, depth_projectors_list, noisy_action_projector, processor
...
def setup_logging(cfg: GenerateConfig):
    run_id = f"EVAL-{cfg.task_suite_name}-{cfg.model_family}-3d-{DATE_TIME}"
...
def load_initial_states(cfg: GenerateConfig, task_suite, task_id: int, log_file=None):
    ...
    if cfg.initial_states_path != "DEFAULT":
        with open(cfg.initial_states_path, "r") as handle:
            all_initial_states = json.load(handle)
...
def prepare_observation(obs, resize_size):
    ...
    observation = {
        ...
        "depth_image": resize_image_for_policy(depth_img, resize_size),
        "wrist_depth_image": resize_image_for_policy(wrist_depth_img, resize_size),
...
def run_episode(
    ...
    if cfg.num_open_loop_steps != NUM_ACTIONS_CHUNK:
        print(
            ...
            f"({NUM_ACTIONS_CHUNK}) constant defined in prismatic.vla.constants! For best performance, execute "
...
def eval_libero(cfg: GenerateConfig) -> float:
    ...
    model, action_head, proprio_projector, depth_projectors_list, noisy_action_projector, processor = initialize_model(cfg)
